...
class ForeignersGrowthTable : AppCompatActivity() {

    /**
    This activity use data from .csv file and create Foreigners growth table.
     */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foreigners_growth_table)
    ...
    fun initForGrowth() {
        ...
        val stk = findViewById(R.id.table_forGrowth) as TableLayout
